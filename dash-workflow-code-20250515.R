...
#===============================================================#
getwd()
# Import & clean BCTQ means data
data <- read_csv("/data/notebooks/rstudio-testbook/grip_strength_review/LC-review-20250515/DASH/yy-data/DASH.csv", na="")
...
# Define column names and time points
outcome_means <- c("mean_1month", "mean_6months","mean_12months")
outcome_sds <- c("sd_1month", "sd_6months", "sd_12months")
time_points <- c("1", "6", "12")
time_unit <- "months"
...
#=============================================================#
# 3 INTERVENTIONS - CUMULATIVE SMC
...
trap_results <- lapply(names(subgroups), function(subgroup_name) {
  ...
  smc_list <- list(
    ...
    smc_tp(data = data_sub, mean_from = "mean_1_5months", sd_from = "sd_1_5months",
...
#ggsave("/data/notebooks/rstudio-testbook/grip_strength_review/LC-review-20250515/DASH/aa-intervention-csmc-plots/dash_csmc_intervention_macro_v1.jpeg", dpi=400)
...
#ggsave("/data/notebooks/rstudio-testbook/grip_strength_review/LC-review-20250515/DASH/aa-intervention-csmc-plots/dash_csmc_intervention_macro_v2.jpeg", dpi=400)
...
#ggsave("/data/notebooks/rstudio-testbook/grip_strength_review/LC-review-20250515/DASH/bb-subgroup-csmc-plots/dash_csmc_subgroups_type_of_trapeziectomy_v1.jpeg", dpi=400)
...
#ggsave("/data/notebooks/rstudio-testbook/grip_strength_review/LC-review-20250515/DASH/bb-subgroup-csmc-plots/dash_csmc_subgroups_type_of_trapeziectomy_v2.jpeg", dpi=400)
...
smc_data <- smc_data %>%
  mutate(label = factor(immobilisation_protocol,
                        levels  = c("2-4 weeks", ">4 weeks"),
                        ordered = TRUE))
#timepoints <- c(0,1,3,6,12)
cols <- RColorBrewer::brewer.pal(n = length(unique(smc_data$label)), name = "Set2")
#cols <- RColorBrewer::brewer.pal(n = max(n_subgroups, 5), name = "Set2")
...
#ggsave("/data/notebooks/rstudio-testbook/grip_strength_review/LC-review-20250515/DASH/bb-subgroup-csmc-plots/dash_csmc_subgroups_immobilisation_v1.jpeg", dpi=400)
...
# 1) Define two colours
cols <- setNames(RColorBrewer::brewer.pal(2, "Set2"),
  # these names *must* exactly match factor levels
  c("2-4 weeks", ">4 weeks"))
...
ggplot() +
  ...
  # Raw SMC points
  geom_point(data = smc_data,
             aes(x = time_point, y = smc_cum, color = label),
             size = 2, shape = 16) +
  scale_color_manual(values = cols,# force the legend to respect factor ordering
    breaks = names(cols)) +
...
#ggsave("/data/notebooks/rstudio-testbook/grip_strength_review/LC-review-20250515/DASH/bb-subgroup-csmc-plots/dash_csmc_subgroups_immobilisation_v2.jpeg", dpi=400)
...
#ggsave("/data/notebooks/rstudio-testbook/grip_strength_review/LC-review-20250515/DASH/bb-subgroup-csmc-plots/dash_csmc_subgroups_dual_mobility_v1.jpeg", dpi=400)
...
#ggsave("/data/notebooks/rstudio-testbook/grip_strength_review/LC-review-20250515/DASH/bb-subgroup-csmc-plots/dash_csmc_subgroups_dual_mobility_v2.jpeg", dpi=400)
...
#ggsave("/data/notebooks/rstudio-testbook/grip_strength_review/LC-review-20250515/DASH/bb-subgroup-csmc-plots/dash_csmc_subgroups_cemented_v1.jpeg", dpi=400)
...
#ggsave("/data/notebooks/rstudio-testbook/grip_strength_review/LC-review-20250515/DASH/bb-subgroup-csmc-plots/dash_csmc_subgroups_cemented_v2.jpeg", dpi=400)
